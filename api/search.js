...
// Calls JioSaavn's internal API and decrypts audio URLs.
// Pure-JS DES-ECB implementation — zero npm dependencies.
...
// ── JioSaavn URL decrypt ─────────────────────────────────────────
const _KEY = '38346591'.split('').map(c => c.charCodeAt(0));
const _DEC_KEYS = _subkeys(_KEY).reverse(); // reversed subkeys = DES decrypt
